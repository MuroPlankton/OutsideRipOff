package com.choicely.outsideripoff.db;

import android.content.Context;

import com.choicely.outsideripoff.GameData;
...
public class RealmHelper {
    ...
    private static final String REALM_NAME = "outsideRipOff.realm";
    ...
    private boolean isSavesAlreadyCreated() {
        return realm.where(GameData.class).count() > 0;
    }
